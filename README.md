...
| <img src="custom-viz-waterfall-chart/examples/example.svg" width="240"> | **[Waterfall Chart](custom-viz-waterfall-chart/)**<br>v1.0.0 | ウォーターフォール（滝／ブリッジ）チャート。増減の積み上げが合計へ届く過程を階段状バーで可視化。種別列（start/total）の自動検出、累計値モード、合計バー自動追加、破線コネクタ付き。 |
