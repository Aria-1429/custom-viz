...
`.spl`: `dist/custom_viz_spotlight_frame-1.2.3-2bb5ec3.spl`

### [1.2.2] - 2026-08-06

#### 変更

- **表示名から `Custom Viz ` プレフィックスを削除**（`Custom Viz Spotlight Frame` → `Spotlight Frame`）。
...
- `dist/custom_viz_spotlight_frame-1.2.1-b4e4674.spl`
