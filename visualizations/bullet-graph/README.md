...
`.spl`: `dist/custom_viz_bullet_graph-1.1.4-<hash>.spl`
...
`.spl`: `dist/custom_viz_bullet_graph-1.1.3-2bb5ec3.spl`

### [1.1.2] - 2026-08-06

#### 変更

- **表示名から `Custom Viz ` プレフィックスを削除**（`Custom Viz Bullet Graph` → `Bullet Graph`）。
...
- `dist/custom_viz_bullet_graph-1.1.1-b4e4674.spl`
...
- `dist/custom_viz_bullet_graph-1.1.0-fcde869.spl`
